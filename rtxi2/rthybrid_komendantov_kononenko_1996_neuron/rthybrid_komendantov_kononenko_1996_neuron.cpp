...
RTHybridKomendantovKononenko1996Neuron::RTHybridKomendantovKononenko1996Neuron(
    void)
    : DefaultGUIModel("RTHybrid Komendantov-Kononenko (1996) neuron model",
                      ::vars, ::num_vars) {
  setWhatsThis(
...
void RTHybridKomendantovKononenko1996Neuron::runge_kutta_65(
...
void RTHybridKomendantovKononenko1996Neuron::euler(
    void (*f)(double *, double *, double *, double), int dim, double dt,
    double *vars, double *params, double aux) {
  double apoyo[dim], retorno[dim];
  double k[4][dim];
...
void RTHybridKomendantovKononenko1996Neuron::select_dt_neuron_model(
...
double
RTHybridKomendantovKononenko1996Neuron::set_pts_burst(double sec_per_burst) {
  int length = 0;
  int method = 3;
...
double RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_V(
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_na_v(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_k(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_na(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_b(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_m_b(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_h_b(
    double *vars, double *params) {
  return (1.000000 / (1.000000 +
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_na_ttx(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_k_tea(
    double *vars, double *params) {
...
double RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_m(
    double *vars, double *params) {
...
double RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_h(
    double *vars, double *params) {
  return (1.000000 / (1.000000 +
...
double RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_n(
    double *vars, double *params) {
  return (1.000000 / (1.000000 +
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_ca(
    double *vars, double *params) {
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_m_ca(
    double *vars, double *params) {
  return (1.000000 / (1.000000 +
...
double
RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_i_ca_ca(
    double *vars, double *params) {
...
double RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_Ca(
    double *vars, double *params) {
  double i_ca = nm_komendantov_kononenko_1996_i_ca(vars, params);
...
void RTHybridKomendantovKononenko1996Neuron::nm_komendantov_kononenko_1996_f(
...
void RTHybridKomendantovKononenko1996Neuron::execute(void) {
  int i;
  ...
  for (i = 0; i < s_points; i++) {
    runge_kutta_65(nm_komendantov_kononenko_1996_f,
                   NM_KOMENDANTOV_KONONENKO_1996_N_VARS,
                   params_model[NM_KOMENDANTOV_KONONENKO_1996_DT], vars_model,
                   params_model, input(0));
  }
...
void RTHybridKomendantovKononenko1996Neuron::initParameters(void) {
...
void RTHybridKomendantovKononenko1996Neuron::update(
...
void RTHybridKomendantovKononenko1996Neuron::customizeGUI(void) {
...
void RTHybridKomendantovKononenko1996Neuron::aBttn_event(void) {}

void RTHybridKomendantovKononenko1996Neuron::bBttn_event(void) {}
