...
class RTHybridBurstAnalysis : public DefaultGUIModel
{

  Q_OBJECT

public:
  RTHybridBurstAnalysis(void);
  virtual ~RTHybridBurstAnalysis(void);
...
private:
  ...
  double max, temp_max;
  double count;
  double thresh_up, thresh_down, range;
  double pts_counter;
  double burst_counter;
  double is_burst;
  double burst_dur_sum, old_burst_time;
