...
RTHybridHindmarshRose1984Neuron::RTHybridHindmarshRose1984Neuron(void)
    : DefaultGUIModel("RTHybrid Hindmarsh-Rose (1984) neuron model", ::vars,
                      ::num_vars) {
...
void RTHybridHindmarshRose1984Neuron::runge_kutta_65(
...
void RTHybridHindmarshRose1984Neuron::select_dt_neuron_model(
...
double
RTHybridHindmarshRose1984Neuron::nm_hindmarsh_rose_1986_v(double *vars,
                                                          double *params) {
...
double
RTHybridHindmarshRose1984Neuron::nm_hindmarsh_rose_1986_y(double *vars,
                                                          double *params) {
...
double
RTHybridHindmarshRose1984Neuron::nm_hindmarsh_rose_1986_z(double *vars,
                                                          double *params) {
...
void RTHybridHindmarshRose1984Neuron::nm_hindmarsh_rose_1986_f(double *vars,
                                                               double *ret,
                                                               double *params,
                                                               double syn) {
...
void RTHybridHindmarshRose1984Neuron::execute(void) {
  int i;
...
void RTHybridHindmarshRose1984Neuron::initParameters(void) {
...
void RTHybridHindmarshRose1984Neuron::update(
...
void RTHybridHindmarshRose1984Neuron::customizeGUI(void) {
...
void RTHybridHindmarshRose1984Neuron::aBttn_event(void) {}

void RTHybridHindmarshRose1984Neuron::bBttn_event(void) {}
