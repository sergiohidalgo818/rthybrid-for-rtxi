...
enum VARIABLE : Widgets::Variable::Id {
  NM_HINDMARSH_ROSE_1986_V = 0,
  NM_HINDMARSH_ROSE_1986_Y,
  NM_HINDMARSH_ROSE_1986_Z
};

enum VIEW_PARAMETER : Widgets::Variable::Id {
  V_NM_HINDMARSH_ROSE_1986_BD = 0,
  V_NM_HINDMARSH_ROSE_1986_I,
  V_NM_HINDMARSH_ROSE_1986_A,
  V_NM_HINDMARSH_ROSE_1986_B,
  V_NM_HINDMARSH_ROSE_1986_C,
  V_NM_HINDMARSH_ROSE_1986_D,
  V_NM_HINDMARSH_ROSE_1986_R,
  V_NM_HINDMARSH_ROSE_1986_S,
  V_NM_HINDMARSH_ROSE_1986_XR,
  V_NM_HINDMARSH_ROSE_1986_V0,
  V_NM_HINDMARSH_ROSE_1986_Y0,
  V_NM_HINDMARSH_ROSE_1986_Z0,
  // V_NM_HINDMARSH_ROSE_1986_V,
  // V_NM_HINDMARSH_ROSE_1986_SP,
  // V_NM_HINDMARSH_ROSE_1986_DT,
  // V_NM_HINDMARSH_ROSE_1986_SYN,
};

enum ARRAY_PARAMETER : Widgets::Variable::Id {
  NM_HINDMARSH_ROSE_1986_I = 0,
  NM_HINDMARSH_ROSE_1986_A,
  NM_HINDMARSH_ROSE_1986_B,
  NM_HINDMARSH_ROSE_1986_C,
  NM_HINDMARSH_ROSE_1986_D,
  NM_HINDMARSH_ROSE_1986_DT,
  NM_HINDMARSH_ROSE_1986_SYN,
  NM_HINDMARSH_ROSE_1986_XR,
  NM_HINDMARSH_ROSE_1986_R,
  NM_HINDMARSH_ROSE_1986_S,
};

inline std::vector<Widgets::Variable::Info> get_default_vars() {
  return {
      {V_NM_HINDMARSH_ROSE_1986_BD, "Burst duration (s)", "Burst duration",
       Widgets::Variable::DOUBLE_PARAMETER, 1.0},
      {V_NM_HINDMARSH_ROSE_1986_I, "I", "Applied external current",
       Widgets::Variable::DOUBLE_PARAMETER, 3.0},
      {V_NM_HINDMARSH_ROSE_1986_A, "a", "Parameter a",
       Widgets::Variable::DOUBLE_PARAMETER, 1.0},
      {V_NM_HINDMARSH_ROSE_1986_B, "b", "Parameter b",
       Widgets::Variable::DOUBLE_PARAMETER, 3.0},
      {V_NM_HINDMARSH_ROSE_1986_C, "c", "Parameter c",
       Widgets::Variable::DOUBLE_PARAMETER, 1.0},
      {V_NM_HINDMARSH_ROSE_1986_D, "d", "Parameter d",
       Widgets::Variable::DOUBLE_PARAMETER, 5.0},
      {V_NM_HINDMARSH_ROSE_1986_R, "r", "Parameter r",
       Widgets::Variable::DOUBLE_PARAMETER, 0.0021},
      {V_NM_HINDMARSH_ROSE_1986_S, "s", "Parameter s",
       Widgets::Variable::DOUBLE_PARAMETER, 4.0},
      {V_NM_HINDMARSH_ROSE_1986_XR, "xr", "Parameter xr",
       Widgets::Variable::DOUBLE_PARAMETER, -1.6},
      {V_NM_HINDMARSH_ROSE_1986_V0, "x0", "Membrane potential",
       Widgets::Variable::DOUBLE_PARAMETER, -0.712841},
      {V_NM_HINDMARSH_ROSE_1986_Y0, "y0", "Parameter y",
       Widgets::Variable::DOUBLE_PARAMETER, -1.936880},
      {V_NM_HINDMARSH_ROSE_1986_Z0, "z0", "Parameter z",
       Widgets::Variable::DOUBLE_PARAMETER, 3.165680},
      // {V_NM_HINDMARSH_ROSE_1986_V, "v", "Membrane potential",
      //  Widgets::Variable::DOUBLE_PARAMETER, 0.0},
      // {V_NM_HINDMARSH_ROSE_1986_SP, "s_points", "Number of integration
      // steps",
      //  Widgets::Variable::DOUBLE_PARAMETER, 0.0},
      // {V_NM_HINDMARSH_ROSE_1986_DT, "dt", "Integration time step",
      //  Widgets::Variable::DOUBLE_PARAMETER, 0.05},
      // {V_NM_HINDMARSH_ROSE_1986_SYN, "syn", "Synaptic current",
      //  Widgets::Variable::DOUBLE_PARAMETER, 0.0},
  };
}
...
private:
  ...
  static void nm_hindmarsh_rose_1986_f(double *vars, double *ret,
