...
void rthybrid_hindmarsh_rose_1984_neuron::Component::execute() {
  ...
  case RT::State::EXEC:
    ...
    for (i = 0; i < s_points; i++) {
      runge_kutta_65(nm_hindmarsh_rose_1986_f, 3,
                     params_model[NM_HINDMARSH_ROSE_1986_DT], vars_model,
                     params_model, readinput(0));
    }

    writeoutput(0, vars_model[NM_HINDMARSH_ROSE_1986_V] / 1000.0);
    writeoutput(1, vars_model[NM_HINDMARSH_ROSE_1986_V]);

    // TODO: Update values and refresh

    // setValue<double>(V_NM_HINDMARSH_ROSE_1986_V,
    //                  vars_model[NM_HINDMARSH_ROSE_1986_V]);
    // setValue<double>(V_NM_HINDMARSH_ROSE_1986_SP, s_points);
    // setValue<double>(V_NM_HINDMARSH_ROSE_1986_DT,
    //                  params_model[NM_HINDMARSH_ROSE_1986_DT]);
    // setValue<double>(V_NM_HINDMARSH_ROSE_1986_SYN,
    //                  params_model[NM_HINDMARSH_ROSE_1986_SYN]);
    //
    break;
  case RT::State::INIT:
  ...
  case RT::State::MODIFY:
    burst_duration_value = getValue<double>(V_NM_HINDMARSH_ROSE_1986_BD);
    freq = 1.0 / (period * 1e-3);
    ...
    params_model[NM_HINDMARSH_ROSE_1986_A] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_A);
    params_model[NM_HINDMARSH_ROSE_1986_B] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_B);
    params_model[NM_HINDMARSH_ROSE_1986_C] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_C);

    params_model[NM_HINDMARSH_ROSE_1986_R] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_R);
    params_model[NM_HINDMARSH_ROSE_1986_S] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_S);
    params_model[NM_HINDMARSH_ROSE_1986_XR] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_XR);

    params_model[NM_HINDMARSH_ROSE_1986_I] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_I);

    params_model[NM_HINDMARSH_ROSE_1986_I] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_I);

    vars_model[VARIABLE::NM_HINDMARSH_ROSE_1986_V] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_V0);
    vars_model[VARIABLE::NM_HINDMARSH_ROSE_1986_Y] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_Y0);
    vars_model[VARIABLE::NM_HINDMARSH_ROSE_1986_Z] =
        getValue<double>(V_NM_HINDMARSH_ROSE_1986_Z0);
...
void rthybrid_hindmarsh_rose_1984_neuron::Component::initParameters(void) {
  ...
  vars_model[NM_HINDMARSH_ROSE_1986_V] =
      getValue<double>(V_NM_HINDMARSH_ROSE_1986_V0);
  vars_model[NM_HINDMARSH_ROSE_1986_Y] =
      getValue<double>(V_NM_HINDMARSH_ROSE_1986_Y0);
  vars_model[NM_HINDMARSH_ROSE_1986_Z] =
      getValue<double>(V_NM_HINDMARSH_ROSE_1986_Z0);
  ...
  params_model[NM_HINDMARSH_ROSE_1986_C] =
      getValue<double>(V_NM_HINDMARSH_ROSE_1986_C);
  params_model[NM_HINDMARSH_ROSE_1986_D] =
      getValue<double>(V_NM_HINDMARSH_ROSE_1986_D);
}
...
void rthybrid_hindmarsh_rose_1984_neuron::Component::nm_hindmarsh_rose_1986_f(
...
double rthybrid_hindmarsh_rose_1984_neuron::Component::nm_hindmarsh_rose_1986_v(
    double *vars, double *params) {
  return vars[NM_HINDMARSH_ROSE_1986_Y] +
         params[NM_HINDMARSH_ROSE_1986_B] *
             (vars[NM_HINDMARSH_ROSE_1986_V] * vars[NM_HINDMARSH_ROSE_1986_V]) -
         params[NM_HINDMARSH_ROSE_1986_A] *
             (vars[NM_HINDMARSH_ROSE_1986_V] * vars[NM_HINDMARSH_ROSE_1986_V] *
              vars[NM_HINDMARSH_ROSE_1986_V]) -
         vars[NM_HINDMARSH_ROSE_1986_Z] + params[NM_HINDMARSH_ROSE_1986_I] -
         params[NM_HINDMARSH_ROSE_1986_SYN];
}

double rthybrid_hindmarsh_rose_1984_neuron::Component::nm_hindmarsh_rose_1986_y(
    double *vars, double *params) {
  return params[NM_HINDMARSH_ROSE_1986_C] -
         params[NM_HINDMARSH_ROSE_1986_D] * vars[NM_HINDMARSH_ROSE_1986_V] *
             vars[NM_HINDMARSH_ROSE_1986_V] -
         vars[NM_HINDMARSH_ROSE_1986_Y];
}

double rthybrid_hindmarsh_rose_1984_neuron::Component::nm_hindmarsh_rose_1986_z(
    double *vars, double *params) {
  return params[NM_HINDMARSH_ROSE_1986_R] *
         (params[NM_HINDMARSH_ROSE_1986_S] *
              (vars[NM_HINDMARSH_ROSE_1986_V] -
               params[NM_HINDMARSH_ROSE_1986_XR]) -
          vars[NM_HINDMARSH_ROSE_1986_Z]);
}
